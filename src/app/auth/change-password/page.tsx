    ...
    <div className="min-h-screen bg-sc-cream flex items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h1 className="font-serif text-2xl text-sc-navy">Set Your Password</h1>
            <p className="text-sc-gray text-sm mt-1">
              Your account was set up by an administrator. Choose a new password to continue.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl bg-white border border-sc-gray-100 shadow-card p-6">
          {success ? (
            <div className="text-center py-4">
              <p className="text-sc-teal font-medium">Password updated! Redirecting…</p>
            </div>
          ) : (
